...
class pix2pix():
    def __init__(self, batchsize=1, img_h=128, img_w=128, lambda_l1=100, path="./dataset/train/"):
    ...
    def generator(self, inputs_condition):
        ...
        with tf.variable_scope("generator"):
            ...
            outputs1 = tf.nn.relu(tf.concat([tf.nn.dropout(instanceNorm("in9", deconv2d("dconv1", inputs8, 512, 5, 1)), 0.5), inputs7], axis=3))  # 2x2x512
